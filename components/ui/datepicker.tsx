...
export function Datepicker({
  ...
  const parseDate = (dateString: string): Date | null => {
    ...
    const month = parseInt(cleanString.substring(0, 2)) - 1;
    const day = parseInt(cleanString.substring(2, 4));
    const year = parseInt('20' + cleanString.substring(4, 6));
      ...
      <div ref={containerRef} className="relative">
        <div className="relative">
          <input
            ...
            required={required}
            className={`
              w-full px-3 py-2 border-2 font-medium
