    ...
    <>
      <div className="mt-4 lg:mt-20 lg:w-2/5 lg:ml-28">
        ...
        <p className="mt-12 leading-loose dark:text-neutral-400 text-neutral-500">
          ...
          All of your goals and notes are saved in a filterable calendar across days, weeks, months, and years so you can learn from your aims, balance, and consistency. Plus, you'll be able to share with family and
          friends your thinking in different seasons of life.
        </p>
